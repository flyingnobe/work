...
class traceAPI:
    ...
    # trace查找功能
    def query(self, mode: str, pod: str, size: Union[int, str], start_time:Union[int,datetime,str,None] , end_time:Union[int,datetime,str,None], label=None):
